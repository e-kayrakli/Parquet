...
- Apache Arrow and Parquet C++ libraries (25.0.1 or compatible)

The C++ prerequisite libraries must be installed and findable by `pkg-config`. The packages are typically named `arrow` and `parquet`. On Ubuntu, you can install them with:
